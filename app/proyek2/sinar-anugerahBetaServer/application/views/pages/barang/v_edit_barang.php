            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form  method="post" enctype= "multipart/form-data" action="<?php echo site_url('Barang_Controller/proses_edit_barang')?>" class="form-horizontal" id="popup-validation">
                            ...
                            <input type="hidden" name="id_barang" value="<?php echo $row->ID_BARANG;?>">
                                ...
                                <div class="col-lg-8">
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                        <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?php echo base_url('uploads/'.$row->GBR_BARANG)?>" alt="" />
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <input type="text" class="validate[required] form-control" name="nm_barang" id="username" value="<?php echo $row->NM_BARANG; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class=" col-lg-4">
                                    <input class="validate[required,custom[number]] form-control" type="text" name="stok_barang" id="stok_barang" value="<?php echo $row->STOK_BARANG?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-lg-4">Rusak</label>
                                <div class=" col-lg-4">
                                    <input class="validate[required,custom[number]] form-control" type="text" name="rusak_barang" id="rusak_barang" value="<?php echo $row->RUSAK_BARANG?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-lg-4">Harga</label>
                                <div class=" col-lg-4">
                                    <input class="validate[required,custom[number]] form-control" type="text" name="harga_barang" id="harga_barang" value="<?php echo $row->HARGA_BARANG?>" />
                                </div>
                            </div>
                            <?php }
                                }
