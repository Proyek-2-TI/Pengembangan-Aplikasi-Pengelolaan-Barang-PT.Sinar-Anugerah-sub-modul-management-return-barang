...
class Penjualan_model extends CI_Model{
    ...
    function getAllDataPenjualan(){
        return $this->db->query("
            SELECT *
            FROM YANDA.TBL_PENJUALAN 
            INNER JOIN YANDA.TBL_CUSTOMER ON TBL_PENJUALAN.ID_CUSTOMER = TBL_CUSTOMER.ID_CUSTOMER
            INNER JOIN YANDA.TBL_PEGAWAI ON TBL_PENJUALAN.ID_PEGAWAI = TBL_PEGAWAI.ID_PEGAWAI
